            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            <div>
                                <h5 class="mb-0">Completed Entries</h5>
                    ...
                    <div class="card-body px-0 pb-0">
                        <div class="ms-auto my-auto mt-lg-0 mt-4 p-3">
                            <div class="ms-auto my-auto">
                                ...
                                <a href="{{ route('admin.inprogress.data') }}" class="btn btn-outline-primary btn-sm mb-0 mt-2">In Progress</a>
                                <a href="{{ route('admin.complete.data') }}" class="btn bg-gradient-primary btn-sm mb-0 mt-2">Completed</a>
                        ...
                        <div class="px-3">
                                <div class="table-responsive">
                                    <div id="table_body">
                                        <table class="table table-flush" id="complete-data-list">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#complete-data-list').DataTable({
                pageLength: 50,
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.complete.data') }}",
                columns: [
                    {
                        data: 'name',
                        name: 'name',
