                    ...
                    <div class="card-body px-0 pb-0">
                        <div class="ms-auto my-auto mt-lg-0 mt-4 p-3">
                            <div class="ms-auto my-auto">
                                ...
                                <a href="{{ route('admin.duplicate.data') }}" class="btn bg-gradient-primary btn-sm mb-0 mt-2">Duplicate Entries</a>
                            </div>
                        </div>
                        <div class="px-3">
                            <div class="table-responsive">
                                <div id="table_body">
                                    <table class="table table-flush" id="all-data-list">
                                        <thead class="thead-light">
                                            <th class="text-sm">Name</th>
                                            <th class="text-sm">Inmate ID</th>
                                            <th class="text-sm">Request For</th>
                                            <th class="text-sm">Tracking Number</th>
                                            <th class="text-sm">Attachment</th>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#all-data-list').DataTable({
                pageLength: 50,
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.duplicate.data') }}",
                columns: [
                    {
                        data: 'name',
                        name: 'name',
